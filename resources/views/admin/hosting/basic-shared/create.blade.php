@section('title', 'Create Hosting List')
...
<div class="grid grid-cols-12 gap-6 mt-5">
  <div class="intro-y col-span-12">
      ...
      <form action="{{ route('admin.hosting.basic.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="intro-y box p-5">
          <div class="grid grid-cols-12 gap-6">
            <div class="col-span-6">
              <label for="crud-form-1" class="form-label">Plan Name</label>
              <input id="crud-form-1" name="plan_name" type="text" class="form-control w-full" required placeholder="Plan Name...">
            </div>
            <div class="col-span-6">
              <label for="crud-form-1" class="form-label">Duration</label>
              <input id="crud-form-1" name="plan_duration" type="text" class="form-control w-full" required placeholder="ex: Yearly">
            </div>
            <div class="col-span-6">
              <label for="crud-form-1" class="form-label">Plan Cost</label>
              <input id="crud-form-1" name="plan_cost" type="text" class="form-control w-full" required placeholder="ex: $100">
            </div>
            <div class="col-span-6">
              <label for="crud-form-1" class="form-label">Bonus Plus</label>
              <input id="crud-form-1" name="plan_bonus" type="text" class="form-control w-full" placeholder="ex: lifetiem domain free">
            </div>
