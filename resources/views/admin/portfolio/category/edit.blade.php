@section('title', 'Edit Category - Portfolio')
...
<div class="grid grid-cols-12 gap-6 mt-5">
  <div class="intro-y col-span-12">
      ...
      <form action="{{ route('admin.portfolio.update-category', $category->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
