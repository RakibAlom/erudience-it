@section('title', 'Licence Info - ErudienceIT')
@section('meta-title', 'Licence Info - ErudienceIT')
@section('meta-description', $g_info->description)
@section('meta-keywords', $g_info->keywords)
@section('og-title', 'Licence Info - ErudienceIT')
@section('og-description', $g_info->description)
@section('tw-title', 'Licence Info - ErudienceIT')
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-6 text-center">
          <h2 class="inner-hero__title">Licence Info</h2>
        </div>
      </div>
    </div>
  </section>
